...
import { KeyValueStoreEntity } from 'siopv2-oid4vp-rp-rest-api/.yalc/@veramo/kv-store'
import { kvStoreMigrations } from 'siopv2-oid4vp-rp-rest-api/.yalc/@veramo/kv-store'
